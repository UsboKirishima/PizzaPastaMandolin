 ...
 |  __ (_)            |  __ \        | |      |  \/  |               | |     | (_)      
 | |__) | __________ _| |__) |_ _ ___| |_ __ _| \  / | __ _ _ __   __| | ___ | |_ _ __  
 |  ___/ |_  /_  / _` |  ___/ _` / __| __/ _` | |\/| |/ _` | '_ \ / _` |/ _ \| | | '_ \ 
 | |   | |/ / / / (_| | |  | (_| \__ \ || (_| | |  | | (_| | | | | (_| | (_) | | | | | |
...
3. Compile and run! 
   gcc main.c cli_colors.c integration.c Dos.c -o main
   ./main

  PS: your can run the bash file for run all files
